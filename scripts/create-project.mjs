...
export function createProject({ entry, target, hubRoot = root, brief, keepHistory = false }) {
  ...
  try {
    ...
    const metadata = { template: entry.id, repository: entry.repository, ref: entry.ref, commit, profile: entry.profile, skills: entry.skills, generatorVersion: '1.0.3', adapterMode: 'portable-forwarders' };
